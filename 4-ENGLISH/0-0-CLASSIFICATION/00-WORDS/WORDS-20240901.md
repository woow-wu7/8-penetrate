...
2
correspond 对应 相当于 类似于 v
respond 回应 v
【 correspond to. 与...相对应 】
// The 'A' field corresponds to the 'B' field in the database. 'A'字段对应于数据库中的'B'字段
...
4
unique 唯一的 adj
// TIPS: Pay attention to the pronunciation of the word 'unique'. [unique]
```
...
-
abstract 抽象的 adj
【 abstract concept. 抽象的概念 】--------------- 【 concept 概念 观念 n 】
【 abstract art. 抽象艺术 n 】
// TIPS: Pay attention to the pronunciation of the word 'concept'. [concept-概念/观念]

7
ordinary 普通的 adj
【 ordinary life. 普通生活 n 】
// Ordinary man 【 live 】 ordinary 【 lives 】.
// live 过v 居住v 活的adj
// life -> lives.

8
Set off fireworks. 放烟花
Fly a kongming lantern. 放孔明灯
```
...
sensory 感觉的 adj
【 sensory organ. 感觉器官 】
// The skin is a sensory organ. 皮肤是感觉器官

【 be full of. 充满 v 】
// He is full of strength. 他充满了力量
```
