...
-
- 5
- `origin 起源 源头 出生` // TIPS: pay attention to pronunciation.
- `ancestor 祖先`
- `【 The origin of. ...的起源 】`
...
- `selfie 自拍 自拍照`
- `【 selfie stick. 自拍杆 】`
- `【 stick shift. 换挡杆 】` // shift gears. 换挡 // first gear. 一档 // shift into drive. 切换成驾驶模式
...
There are many trees 【 on the both sides of 】 the road. 马路两边有很多树
You can imagine there is a martial arts novel. 你可以想象这里有一本武侠小说
I feel dizzy, I want to go out for a walk. 我想出去散散步
---
// path 路径 小路
// next to = near 旁边
// novel 小说
